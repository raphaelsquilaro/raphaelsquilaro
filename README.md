...
Sistema inteligente de gestão acadêmica com:
...
- [ ] Construir API enterprise-grade

- [ ] Finalizar Meritum MVP

- [ ] Aprender Docker avançado

- [ ] Estudar microsserviços

- [ ] Melhorar modelagem de banco

- [ ] Criar portfólio full-stack
...
> Não quero apenas programar.  

> Quero entender sistemas, resolver problemas e construir soluções que realmente façam diferença.
